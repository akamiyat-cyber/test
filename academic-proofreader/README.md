...
- Tabs: 執筆支援 (drafting), 本文校正 (body proofreading), 図表キャプション (figure/table captions), 文献・引用 (references & citations), 品質・投稿準備 (quality & submission prep), 査読対応 (response to reviewers).
